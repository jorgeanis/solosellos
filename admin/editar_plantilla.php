...
$id = $_GET['id'] ?? null;
if (!$id) {
    echo "<script>window.location.href='plantillas.php';</script>";
    exit;
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        echo "<script>window.location.href='plantillas.php?msg=updated';</script>";
        exit;
...
if (!$plantilla) die("Plantilla no encontrada.");
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4" data-aos="fade-down">
        <div>
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">
                <i class="fas fa-edit text-brand-600 mr-2"></i>Editar Plantilla
            </h1>
            <p class="text-gray-500 text-sm mt-1">Personaliza el diseño y la estructura de tu sello</p>
        </div>
        <div class="flex gap-3">
            ...
            <button type="submit" form="editorForm" class="px-6 py-2 bg-brand-600 text-white rounded-lg hover:bg-brand-700 transition-colors shadow-lg shadow-brand-500/30 font-bold">
    ...
    <form id="editorForm" method="POST" class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div id="tab-content-<?= $i ?>" class="tab-content <?= $i == 1 ? 'block' : 'hidden' ?> space-y-5">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <!-- Reutilizamos el include pero lo envolvemos para estilizar el select generado -->
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Estilizar los selects de fuentes (que vienen del include PHP y no tienen clases de Tailwind)
        ...
        function actualizarVistaPrevia() {
            ...
            for (let i = 1; i <= 4; i++) {
                ...
                // Seguridad: Verificar que los elementos existan antes de leer .value
                datos['linea' + i] = {
                    texto: textoInput ? textoInput.value : '',
                    fuente: fuenteInput ? fuenteInput.value : 'Arial',
        ...
        window.setAlign = function(linea, direccion, btn) {
            ...
            // Buscar todos los botones del grupo
